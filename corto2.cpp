...
int main()
{
    ...
    switch(genero){
        ...
        cout<<"1. Zapato Premium -- Precio: $"<<zapatoPremium<<" -- Precio con descuento: $"<<zapatoPremium-(zapatoPremium*0.2)<<endl;
        ...
        cout<<"1. Zapato Premium -- Precio: $"<<zapatoPremium<<" -- Precio con descuento: $"<<zapatoPremium-(zapatoPremium*0.15)<<endl;
        break;
